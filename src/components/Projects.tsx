...
const Projects: React.FC = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      desc: 'Smart café management and POS dashboard featuring inventory tracking, role-based admin systems, transaction monitoring, and optimized responsive interfaces.',
      tech: ['React', 'TypeScript', 'Tailwind CSS'],
      image: 'img/starbucks-shop.jpeg',
      live: 'https://zhadelintang.github.io/starbrew-cafe/',
      github: 'https://github.com/ZhadeLintang/starbrew-cafe',
      accentClass: 'hover:border-neonPurple/50 hover:shadow-neon-purple text-neonPurple',
    },
    {
      title: 'myBCA',
      desc: 'Modern digital banking interface clone inspired by myBCA, featuring elegant financial dashboards, smooth user interactions, and responsive mobile-first design.',
      tech: ['React TypeScript', 'Tailwind CSS'],
      image: 'img/my-bca.jpeg',
      live: 'https://zhadelintang.github.io/my-bca/',
      github: 'https://github.com/ZhadeLintang/my-bca',
